...
<!--            <th style="text-align: center;">Value4</th>
    ...
    <table style="border: 1px solid">
        ...
        <tr>
            <td style="text-align: center;">
               <?php echo CHtml::encode(CHtml::value($panel->header, 'panel_name')); ?>
            </td>
        </tr>
    </table>
    ...
    <div id="detail_component_group">
        <?php $this->renderPartial('_addDetail', array('panel' => $panel)); ?>
    </div>
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'selectionChanged' => 'js:function(id) {
            ...
            $.ajax({
                ...
                data: $("form").serialize(),
                success: function(html) { $("#detail_component_0").html(html); },
            });
        }',
        'columns' => array(
            array(
