...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            'header' => 'Project',
            'value' => 'CHtml::encode(CHtml::value($data, "purchaseRequestHeader.workOrderProductionHeader.workOrderDrawingHeader.budgetingHeader.saleOrderHeader.project_name"))'
        ),
        array(
            'header' => 'Client',
            'value' => 'CHtml::encode(CHtml::value($data, "purchaseRequestHeader.workOrderProductionHeader.workOrderDrawingHeader.budgetingHeader.saleOrderHeader.client_company"))'
        ),
        array(
            'header' => 'SO #',
            'value' => 'CHtml::encode($data->purchaseRequestHeader->workOrderProductionHeader->workOrderDrawingHeader->budgetingHeader->saleOrderHeader->getNumber(SaleOrderHeader::CN_CONSTANT))'
        ),
        array(
            'header' => 'Supplier',
