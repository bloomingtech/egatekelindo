...
$this->breadcrumbs = array(
    'Purchase' => array('purchaseRequestList'),
    'View',
);
?>
...
$this->widget('zii.widgets.CDetailView', array(
    ...
    'attributes' => array(
        ...
        array(
            'label' => 'Project Name',
            'value' => CHtml::encode(CHtml::value($purchase, 'purchaseRequestHeader.workOrderProductionHeader.workOrderDrawingHeader.budgetingHeader.saleOrderHeader.project_name')),
        ),
        array(
            'label' => 'Client',
            'value' => CHtml::encode(CHtml::value($purchase, 'purchaseRequestHeader.workOrderProductionHeader.workOrderDrawingHeader.budgetingHeader.saleOrderHeader.client_company')),
        ),
        array(
            'label' => 'SO #',
            'value' => (empty($purchase->purchaseRequestHeader->workOrderProductionHeader)) ? 'N/A' : CHtml::encode($purchase->purchaseRequestHeader->workOrderProductionHeader->workOrderDrawingHeader->budgetingHeader->saleOrderHeader->getNumber(SaleOrderHeader::CN_CONSTANT)),
        ),
        array(
            'label' => 'Tanggal Kirim',
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        array(
            'header' => 'Description',
            'value' => '($data->purchase_request_detail_component_id === null) ? CHtml::encode(Chtml::value($data, "purchaseRequestDetailService.name")) : CHtml::encode(Chtml::value($data, "purchaseRequestDetailComponent.component.name"))',
        ),
        array(
            'header' => 'Quantity',
...
<table>
    <tr style="background-color: skyblue">
        ...
        <td style="text-align: right; width: 21%;">
            <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($purchase, 'subTotalRequest'))); ?>
        </td>
    </tr>
    <tr style="background-color: skyblue">
        <td style="text-align:right; width: 70%;">
        ...
        <td style="text-align: right; width: 21%;">
            <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::encode(CHtml::value($purchase, 'calculatedTaxRequest')))); ?>
        </td>
    </tr>
    <tr style="background-color: skyblue">
        <td style="text-align:right; width: 70%;">
        ...
        <td style="text-align: right; width: 21%;">
            <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::encode(CHtml::value($purchase, 'grandTotalRequest')))); ?>
        </td>
    </tr>
</table>
<br />
<br />
<div id="link">
    <?php echo CHtml::link('Create', array('purchaseRequestList')); ?>
