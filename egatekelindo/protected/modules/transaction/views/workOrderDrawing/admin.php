    ...
    'columns' => array(
        ...
        array(
         ...
         array(
            ...
            'value' => 'CHtml::encode($data->budgetingHeader->saleOrderHeader->getNumber(SaleOrderHeader::CN_CONSTANT))',
            'htmlOptions' => array('style' => 'width: 250px'),
        ),
        array(
            'header' => 'Project',
            'filter' => CHtml::textField('ProjectName', $projectName, array('maxLength' => 60, 'size' => 10)),
            'value' => 'CHtml::encode(CHtml::value($data->budgetingHeader->saleOrderHeader,"project_name"))',
        ),
        array(
            'header' => 'Company',
