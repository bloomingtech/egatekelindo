    ...
    <div class="container">
        <div class="span-12">
            ...
            <div class="row">
                ...
                <?php echo CHtml::encode(CHtml::value($requirementHeader, 'saleOrderHeader.client_company')); ?>
            </div>
            <div class="row">
                <?php echo CHtml::label('SO #', ''); ?>
                <?php echo CHtml::encode($requirementHeader->saleOrderHeader->getNumber(SaleOrderHeader::CN_CONSTANT)); ?>
            </div>
        ...
        <div class="span-12 last">
            ...
            <div class="row">
                <?php echo CHtml::label('Termin Pembayaran', ''); ?>
