...
<table class="memo">
    ...
    <tr>
        <td colspan="8" style="border-bottom: 2px solid transparent !important;">PT. EGA TEKELINDO PRIMA</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" style="border-top: 2px solid transparent !important;">
            SO: <?php echo CHtml::encode($purchase->requirementHeader->saleOrderHeader->getNumber(SaleOrderHeader::CN_CONSTANT)); ?> |
            REQ: <?php echo CHtml::encode($purchase->requirementHeader->getCodeNumber($purchase->requirementHeader->cnConstant)); ?> |
            SPK: <?php echo CHtml::encode($purchase->requirementHeader->workOrderProductionHeader->getCodeNumber(WorkOrderProductionHeader::CN_CONSTANT)); ?>
        </td>
    ...
    <?php foreach ($purchase->purchaseDetailRequirements as $i => $detail) : ?>
        <tr>
            ...
            <td style="border-bottom: 1px solid transparent !important" colspan="2">
                ...
                <?php echo CHtml::encode(CHtml::value($detail, 'requirementDetailComponent.component.componentBrand.name')); ?> - 
                <?php echo CHtml::encode(CHtml::value($detail, 'requirementDetailComponent.component.type')); ?>
            </td>
    ...
    <?php endfor; ?>
    <tr>
        <td colspan="7" style="text-align: right; border-top: 2px solid black; border-bottom: 1px solid transparent !important">SUB TOTAL</td>
        <td style="text-align: right; border-top: 2px solid black; border-bottom: 1px solid transparent !important"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', CHtml::value($purchase, "subTotalRequirement"))); ?></td>
    </tr>
    <tr>
        ...
        <td style="text-align: right; border-bottom: 1px solid transparent !important"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', CHtml::value($purchase, "calculatedTaxRequirement"))); ?></td>
    </tr>
    <tr>
        <td colspan="7" style="text-align: right; font-weight: bold">GRAND TOTAL</td>
        <td style="text-align: right; font-weight: bold"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', CHtml::value($purchase, "grandTotalRequirement"))); ?></td>
    </tr>
</table>
