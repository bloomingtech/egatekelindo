...
<table style="border: 1px solid">
    ...
    <?php if ($estimationComponentGroup->detailComponents): ?>
        <?php foreach ($estimationComponentGroup->detailComponents as $i => $detail): ?>
            ...
            <tr class="component-row">
                ...
                <td style="text-align: center; width: 3%">
                    ...
                    echo CHtml::activeTextField($detail, "[$i]quantity", array('size' => 7, 'maxLength' => 20,
                        'onchange' => CHtml::ajax(array(
                            'type' => 'POST',
                            'dataType' => 'JSON',
                            'url' => CController::createUrl('ajaxJsonTotalComponent', array('id' => $estimationComponentGroup->header->id, 'i' => $i)),
                ...
                <td style="text-align: RIGHT; width: 10%">
                    <span id="basic_price_<?php echo $i; ?>">
                        <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $detail->getBasicPrice($estimationComponentGroup->header->estimationPanel->estimationHeader->estimationBrandDiscounts))); ?>
                    </span>                        
                </td>
                ...
                <td style="text-align: center;">
                    ...
                    echo CHtml::activeDropDownList($detail, "[$i]accesories_phase_id", CHtml::listData(AccesoriesPhase::model()->findAll(), 'id', 'nameFull', 'phaseNumberString'), array(
                        ...
                        'onchange' => CHtml::ajax(array(
                            'type' => 'POST',
                            'dataType' => 'JSON',
                            'url' => CController::createUrl('ajaxJsonAccesoriesValueComponent', array('id' => $estimationComponentGroup->header->id, 'i' => $i)),
                            'success' => 'function(data) {
                ...
                <td style="text-align: right">
                    <span id="total_<?php echo $i; ?>">
                        <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $detail->getTotal($estimationComponentGroup->header->estimationPanel->estimationHeader->estimationBrandDiscounts))); ?>
                    </span>
                </td>
                    ...
                    <?php if ($detail->isNewRecord): ?>
                        ...
                        echo CHtml::button('Delete', array(
                            'onclick' => CHtml::ajax(array(
                                'type' => 'POST',
                                'url' => CController::createUrl('ajaxHtmlRemoveComponentPanel', array('id' => $estimationComponentGroup->header->id, 'i' => $i)),
    ...
    <tr style="background-color: aquamarine">
        ...
        <td style="text-align: right; font-weight: bold">
            <span id="sub_total">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $estimationComponentGroup->getSubTotal())); ?>
            </span>
        </td>
        <td></td>
        <td></td>
