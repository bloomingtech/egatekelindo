...
<div id="memoheader">
    ...
    <div style="font-size: 2.5em">PACKING LIST</div>
</div>
        ...
        <div class="divtablecell hcolumn1">
            <div class="divtable">
                <div class="divtablerow">
                    ...
                    <div class="divtablecell info hcolumn1value"><?php echo CHtml::encode($packingList->getCodeNumber(PackingListHeader::CN_CONSTANT)); ?></div>
                </div>
                <div class="divtablerow">
                ...
                <div class="divtablerow">
                    ...
                    <div class="divtablecell info hcolumn1value"><?php echo CHtml::encode($packingList->partListHeader->getCodeNumber(PartListHeader::CN_CONSTANT)); ?></div>
                </div>
...
<table class="memo">
    ...
    <?php foreach ($packingList->packingListDetails as $i => $detail): ?>
        <tr class="titems">
            <td><?php echo CHtml::encode(CHtml::value($detail, 'partListDetail.component.name')); ?></td>
            <td><?php echo CHtml::encode(CHtml::value($detail, 'partListDetail.component.componentBrand.name')); ?></td>
