...
<table class="report">
    <tr id="header1">
        ...
        <th class="width1-2" style="text-align: left">Penerimaan #</th>
        <th class="width1-3" style="text-align: left">Supplier</th>
        <th class="width1-4" style="text-align: left">PO #</th>
        <th class="width1-5" style="text-align: left">Tanggal</th>
    ...
    <?php foreach ($receiveSummary->dataProvider->data as $header): ?>
        <tr class="items1">
            ...
            <td class="width1-2" style="text-align: left"><?php echo CHtml::encode($header->getCodeNumber(ReceiveHeader::CN_CONSTANT)); ?></td>
            <td class="width1-3" style="text-align: left"><?php echo CHtml::encode(CHtml::value($header, 'supplier.company')); ?></td>
            <td class="width1-4" style="text-align: left"><?php echo CHtml::encode(CHtml::value($header, 'purchase_number')); ?></td>
            <td class="width1-5" style="text-align: left"><?php echo CHtml::encode(Yii::app()->dateFormatter->format('d MMMM yyyy', strtotime($header->purchase_date))); ?></td>
